...
class ListviewPreviousEmployee extends StatelessWidget {
  final List<EmployeeModel> employeeData;
  final Function undo;
  const ListviewPreviousEmployee(
    ...
    return ListView.separated(
      ...
      itemBuilder: (context, index) {
        return Dismissible(
          ...
          key: Key(previousEmployee[index].id.toString()),
          direction: DismissDirection.endToStart,
          onDismissed: (direction) {
            context.read<HistoryCubit>().addHistory(previousEmployee[index]);
            context
                .read<EmployeeCubit>()
                .deleteEmployee(previousEmployee[index]);
          ...
          child: GestureDetector(
              ...
              Navigator.push(
                ...
                MaterialPageRoute(
                  builder: (context) => AddDetailScreen(
                    ...
                    employeeData: previousEmployee[index],
                  ),
                ),
              );
            },
            child: Container(
                ...
                child: Column(
                  ...
                  children: [
                    Text(
                      previousEmployee[index].fullName,
                    ...
                    const SizedBox(height: 6),
                    Text(
                      "${DateFormat('dd MMM, yyyy').format(previousEmployee[index].joinedDate)} - ${DateFormat('dd MMM, yyyy').format(previousEmployee[index].resignedDate!)}",
